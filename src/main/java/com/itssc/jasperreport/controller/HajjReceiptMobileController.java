...
@RequestMapping("/JasperReports/api/v2")
public class HajjReceiptMobileController {

    private final com.itssc.jasperreport.service.api.HajjReceiptService HajjReceiptService;
    ...
    public ResponseEntity<DefaultResponse> downloadHajjReceipt(
        ...
        return Responder.success(HajjReceiptService.downloadHajjReceiptMobile(HajjReceiptRequestDTO));
    }
}
