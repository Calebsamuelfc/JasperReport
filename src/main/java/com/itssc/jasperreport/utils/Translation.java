...
public enum Translation {
    ...
    MYCONTRACTS("MY CONTRACTS","MES CONTRATS"),
    DATECREATED("DATE CREATED","DATE DE CRÉATION"),
    SERVICEDEFINITION("SERVICE DEFINITION","DÉFINITION DE SERVICE");
    INFINITYUSERID("InfinityUserId", "ID utilisateur Infinity"),
    CUSTOMERREPORTS("CUSTOMER REPORTS", "RAPPORTS CLIENTS"),
    CUSTOMERSTATUS("CustomerStatus", "STATUT DE L'UTILISATEUR"),
    ENROLLMENTDATE("EnrollmentDate", "DATE D'INSCRIPTION À L'E-BANQUE"),
